...
public class ControllerLogging {
    ...
    @Before("within(com.epam.finaltask.restcontroller..*)")
    public void logBefore(JoinPoint joinPoint) {
        log.info("Entering {} with arguments: {}", joinPoint.getSignature(), joinPoint.getArgs());
    }

    @AfterReturning(pointcut = "within(com.epam.finaltask.restcontroller..*)", returning = "result")
    public void logAfterReturning(JoinPoint joinPoint, Object result) {
        log.info("Exiting {} with result: {}", joinPoint.getSignature(), result);
    }

    @AfterThrowing(pointcut = "within(com.epam.finaltask.restcontroller..*)", throwing = "error")
